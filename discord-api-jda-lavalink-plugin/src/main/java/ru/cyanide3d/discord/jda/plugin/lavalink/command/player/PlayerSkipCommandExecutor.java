...
public class PlayerSkipCommandExecutor extends AbstractPlayerCommandExecutor implements SlashExecutor {
    ...
    public void execute(SlashCommandContext ctx) {
        ...
        PlayerActionResult result = playerManager.skip(guildId);
