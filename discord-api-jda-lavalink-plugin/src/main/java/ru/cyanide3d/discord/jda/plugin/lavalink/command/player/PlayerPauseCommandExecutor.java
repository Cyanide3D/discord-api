...
public class PlayerPauseCommandExecutor extends AbstractPlayerCommandExecutor implements SlashExecutor {
    ...
    public void execute(SlashCommandContext ctx) {
        ...
        PlayerActionResult result = playerManager.pause(guildId);
