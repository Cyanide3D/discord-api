...
public class DefaultModalInteractionContext
        extends AbstractInteractionResponseEventContext<ModalInteractionEvent>
        implements ModalInteractionContext {

    public DefaultModalInteractionContext(ModalInteractionEvent event, DiscordRestActionExecutor restActionExecutor) {
